...
public final class BookmarkPickerActivity extends ListActivity {
  ...
  private static final String[] BOOKMARK_PROJECTION = {
      /*Browser.BookmarkColumns.TITLE*/"title",
  ...
  private static final String BOOKMARK_SELECTION = 
      /*Browser.BookmarkColumns.BOOKMARK*/"bookmark" + " = 1 AND " + /*Browser.BookmarkColumns.URL*/"url" + " IS NOT NULL";
  ...
  protected void onCreate(Bundle icicle) {
    ...
    cursor = getContentResolver().query(/*Browser.BOOKMARKS_URI*/Uri.parse("content://browser/bookmarks"), BOOKMARK_PROJECTION,
  ...
  protected void onListItemClick(ListView l, View view, int position, long id) {
    if (!cursor.isClosed() && cursor.moveToPosition(position)) {
      ...
      intent.putExtra(/*Browser.BookmarkColumns.TITLE*/"title", cursor.getString(TITLE_COLUMN));
      intent.putExtra(/*Browser.BookmarkColumns.URL*/"url", cursor.getString(URL_COLUMN));
